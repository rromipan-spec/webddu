...
<head>
    ...
    <link rel="stylesheet" href="/halaman-utama/metropolis.css?v=20260917-1">
    <style>
        body{font-family:"Metropolis","Segoe UI",Arial,sans-serif;background:#EAF2FF;margin:0;padding:40px 16px;color:rgba(23,32,51,.82);font-size:1rem;line-height:1.72}.card{max-width:480px;margin:40px auto;background:#FAFAF7;padding:30px;border:1px solid rgba(7, 86, 214, .16);border-radius:14px;box-shadow:0 12px 35px rgba(23, 32, 51, .1)}h1{color:#063B9E;font-size:clamp(1.8rem,6vw,2.5rem);font-weight:800;line-height:1.08;letter-spacing:-.04em}label{display:block;color:#172033;font-size:.9rem;font-weight:600;margin:16px 0 6px}input{box-sizing:border-box;width:100%;padding:12px;border:1px solid rgba(7, 86, 214, .22);border-radius:8px;background:#FAFAF7;color:#172033;font-size:1rem;line-height:1.5}button{width:100%;padding:13px;margin-top:22px;border:0;border-radius:8px;background:#1769F5;color:#FAFAF7;font-weight:600;cursor:pointer}.message{padding:12px;border-radius:8px;border-left:4px solid #D4A84F;background:#EAF2FF;margin-bottom:16px}.success{border-left-color:#0756D6;background:#EAF2FF}small{color:rgba(23,32,51,.64);font-size:.88rem;font-weight:500;line-height:1.55;display:block;margin-top:15px}
