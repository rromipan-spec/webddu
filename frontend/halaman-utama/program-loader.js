...
function renderProgram(container, program) {
    ...
    const wa = program.whatsapp_number || '6285797571549';
    const message = program.whatsapp_message || `Assalamualaikum, saya ingin berkonsultasi mengenai ${program.title}.`;
    container.innerHTML = `
    <header class="main-header"><div class="container"><nav class="navbar"><div class="logo"><img src="https://lh3.googleusercontent.com/d/1G2xVlrBuc4IU6ynaGf8Xg_c9Y7jSg3Wm" alt="Logo DDU"><span>Dompet Dana Umat</span></div><div class="menu-toggle"><span class="bar"></span><span class="bar"></span><span class="bar"></span></div><div class="nav-links"><div class="close-menu-btn">&times;</div><a href="index.html">Home</a><a href="about.html">About</a><a href="index.html#programs" class="active">Program</a><a href="index.html#blog">Blog</a><a href="index.html#contact">Contact</a></div></nav></div></header>
    <section class="hero" style="background-image:url('${escapeHtml(program.image)}');background-size:cover;background-position:center;padding:220px 0 120px"><div class="hero-overlay" style="background:rgba(10,38,71,.8)"></div><div class="container hero-container" style="text-align:center"><div class="hero-content" style="max-width:100%;margin:0 auto"><h5 style="color:#64b5f6;letter-spacing:2px">LAYANAN DDU</h5><h1 style="color:white;margin-top:10px">${escapeHtml(program.hero_title || program.title)}</h1><p style="color:#cbd5e0">${escapeHtml(program.hero_subtitle)}</p></div></div></section>
    ...
    <section class="cta-minimal fade-in"><div class="container"><h5>LANGKAH KEBAIKAN</h5><h2>Ingin Berkontribusi untuk ${escapeHtml(program.title)}?</h2><p>Konsultasikan donasi Anda secara amanah bersama tim layanan kami.</p><a href="https://wa.me/${encodeURIComponent(wa)}?text=${encodeURIComponent(message)}" class="btn-whatsapp-minimal" target="_blank" rel="noopener noreferrer">Hubungi Admin via WhatsApp →</a></div></section>
    <footer class="footer"><div class="container"><div class="footer-grid"><div class="footer-col"><div class="footer-logo"><img src="https://lh3.googleusercontent.com/d/1G2xVlrBuc4IU6ynaGf8Xg_c9Y7jSg3Wm" alt="Logo DDU"><span>Dompet Dana Umat</span></div><p>Lembaga pengelola dana umat yang amanah dan profesional.</p></div><div class="footer-col"><h4>Contact Info</h4><ul class="contact-info"><li>Jl. Raya Puncak, Bogor</li><li>+62 857 9757 1549</li><li>info@dompetdanaumat.com</li></ul></div></div><div class="footer-bottom"><p>&copy; ${new Date().getFullYear()} Dompet Dana Umat. All Rights Reserved.</p></div></div></footer>
